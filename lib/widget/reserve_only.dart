...
class ReserveOnly extends StatelessWidget {
   ReserveOnly({Key? key, required this.thumbnailUrl}) : super(key: key);
  ...
  Future seatNo({required String seats}) async {
    final docSeat = FirebaseFirestore.instance
        .collection('birhan')
        .doc('reserve')
        .collection("reserveonly")
        .doc();
